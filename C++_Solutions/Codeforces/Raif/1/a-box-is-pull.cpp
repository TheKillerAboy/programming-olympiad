...
int main(){
	...
	while(n--){
		...
		if(start.first==finish.first) cout<<abs(start.second-finish.second)<<'\n';
		else if(start.second==finish.second) cout<<abs(start.first-finish.first)<<'\n';
		else cout<<abs(start.first-finish.first)+abs(start.second-finish.second)+2<<'\n';
	}
